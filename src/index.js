...
export default class Pageable {
            ...
            if (met) {
                if (this.touch) {
                    if (e.changedTouches[0][this.mouseAxis[this.axis]] < this.down[this.axis]) {
                        ...
                        e.changedTouches[0][this.mouseAxis[this.axis]] > this.down[this.axis]
                    ) {
                        dec();
                    }
                } else {
    ...
    update() {
        ...
        // set container size
        this.container.style[size] = `${this.pages.length *
			this.data.window[size]}px`;
        ...
        this.wrapper[this.scrollAxis[this.axis]] =
            this.index * this.data.window[size];

        this.scrollSize =
            this.pages.length * this.data.window[size] - this.data.window[size];
